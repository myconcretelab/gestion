...
const reservationPayloadSchema = z.object({
  ...
  nb_enfants_2_17: z.coerce.number().int().min(0).optional().default(0),
    ...
    records: segments.map((segment, index) => {
      ...
      return {
        ...
        data: {
          ...
          nb_enfants_2_17: payload.nb_enfants_2_17 ?? 0,
...
const hydrateReservation = (reservation: any) => {
  ...
  return {
    ...
    nb_enfants_2_17: Math.max(0, Number(reservation.nb_enfants_2_17) || 0),
      ...
      for (let index = 0; index < segments.length; index += 1) {
        ...
        const createdReservation = await tx.reservation.create({
          data: {
            ...
            nb_enfants_2_17: existing.nb_enfants_2_17 ?? 0,
            prix_par_nuit: prixParNuit,
            prix_total: prixTotal,
