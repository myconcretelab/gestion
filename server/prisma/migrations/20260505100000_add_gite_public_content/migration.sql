...
ALTER TABLE "gites" ADD COLUMN "public_structured_content" TEXT;
ALTER TABLE "gites" ADD COLUMN "public_equipment" TEXT;
ALTER TABLE "gites" ADD COLUMN "public_rooms" TEXT;
ALTER TABLE "gites" ADD COLUMN "public_practical_info" TEXT;
ALTER TABLE "gites" ADD COLUMN "public_location_info" TEXT;
ALTER TABLE "gites" ADD COLUMN "public_latitude" REAL;
ALTER TABLE "gites" ADD COLUMN "public_longitude" REAL;
...
CREATE TABLE "gite_photos" (
  ...
  CONSTRAINT "gite_photos_gite_id_fkey" FOREIGN KEY ("gite_id") REFERENCES "gites" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
