...
ALTER TABLE "expense_recurring_rules" ADD CONSTRAINT "expense_recurring_rules_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "expense_categories"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "expense_recurring_rules" ADD CONSTRAINT "expense_recurring_rules_gestionnaire_id_fkey" FOREIGN KEY ("gestionnaire_id") REFERENCES "gestionnaires"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "expense_recurring_rules" ADD CONSTRAINT "expense_recurring_rules_gite_id_fkey" FOREIGN KEY ("gite_id") REFERENCES "gites"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "expense_entries" ADD CONSTRAINT "expense_entries_gestionnaire_id_fkey" FOREIGN KEY ("gestionnaire_id") REFERENCES "gestionnaires"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "expense_entries" ADD CONSTRAINT "expense_entries_gite_id_fkey" FOREIGN KEY ("gite_id") REFERENCES "gites"("id") ON DELETE CASCADE ON UPDATE CASCADE;
