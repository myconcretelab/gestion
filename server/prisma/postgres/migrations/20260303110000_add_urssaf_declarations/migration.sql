CREATE TABLE "urssaf_declarations" (
    ...
    CONSTRAINT "urssaf_declarations_pkey" PRIMARY KEY ("id")
);

ALTER TABLE "urssaf_declarations" ADD CONSTRAINT "urssaf_declarations_gestionnaire_id_fkey" FOREIGN KEY ("gestionnaire_id") REFERENCES "gestionnaires"("id") ON DELETE CASCADE ON UPDATE CASCADE;
