CREATE TABLE "guest_night_declarations" (
    ...
    CONSTRAINT "guest_night_declarations_pkey" PRIMARY KEY ("id")
);

ALTER TABLE "guest_night_declarations" ADD CONSTRAINT "guest_night_declarations_gite_id_fkey" FOREIGN KEY ("gite_id") REFERENCES "gites"("id") ON DELETE CASCADE ON UPDATE CASCADE;
